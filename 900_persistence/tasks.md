...
- T-28 → **No implementada** (segundo Tracer Bullet `ingest`; en curso — pasos 1-2 del flujo completos: rama `feature/ingest` y `feature_contract.md`; falta paso 3 en adelante)
- T-29 → **No implementada** (paso 3 del Tracer Bullet `ingest`: invocar `feature_definer` para producir `610_features/ingest/definition.md`)
