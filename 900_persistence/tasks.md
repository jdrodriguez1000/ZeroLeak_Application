...
| T-21 | Construir Tracer Bullet `client_scaffold` (artefactos SDD+TDD completos: `feature_contract.md`, notebook, spec, plan, tests, código) | No implementada | 2026-07-12 | diseño ya acordado con el humano (ver `decisions.md` D-15/notas T-12); pendiente crear `610_features/client_scaffold/` y ejecutar el flujo de 13 pasos; es la continuación de T-12 |
