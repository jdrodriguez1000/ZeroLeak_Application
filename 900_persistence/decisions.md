...
## [2026-07-13] D-18 — 🔓 PUNTO ABIERTO: emparejamiento archivo-físico → tipo de contrato
- **Estado:** **ABIERTO** — decisión aún **no tomada**. A resolver cuando se construya el feature del **Contrato de Datos / `load_config`** (posterior a `ingest`).
